...
def test_empty_poset_length() -> None:
...
def test_poset_length(basic_poset: PartiallyOrderedSet[int]) -> None:
    """Test that the poset's length is correctly calculated."""
    assert len(basic_poset) == 2


def test_element_not_in_empty_poset() -> None:
...
def test_element_in_poset(basic_poset: PartiallyOrderedSet[int]) -> None:
    """Test that an element is in the poset."""
    assert 1 in basic_poset


def test_poset_add_element() -> None:
...
def test_poset_add_duplicate_element() -> None:
...
def test_poset_is_less_than(basic_poset: PartiallyOrderedSet[int]) -> None:
...
def test_poset_is_less_than_with_invalid_lower_element(
    basic_poset: PartiallyOrderedSet[int],
) -> None:
...
def test_poset_is_less_than_with_invalid_upper_element(
    basic_poset: PartiallyOrderedSet[int],
) -> None:
...
def test_poset_is_greater_than(basic_poset: PartiallyOrderedSet[int]) -> None:
...
def test_poset_is_greater_than_with_invalid_lower_element(
    basic_poset: PartiallyOrderedSet[int],
) -> None:
...
def test_poset_is_greater_than_with_invalid_upper_element(
    basic_poset: PartiallyOrderedSet[int],
) -> None:
...
def test_poset_add_order(basic_poset: PartiallyOrderedSet[int]) -> None:
...
def test_poset_add_order_with_invalid_lower_element(
    basic_poset: PartiallyOrderedSet[int],
) -> None:
...
def test_poset_add_order_with_invalid_upper_element(
    basic_poset: PartiallyOrderedSet[int],
) -> None:
...
def test_poset_invalid_order() -> None:
