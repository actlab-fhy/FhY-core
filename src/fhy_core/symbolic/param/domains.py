...
from ..solver import check_expression_satisfiability, does_expression_imply
...
def _merge_finite_values(own: Sequence[Any], other: Sequence[Any]) -> tuple[Any, ...]:
    ...
    :func:`~fhy_core.symbolic.param.values.do_param_values_match` strict-kind equality.
    """
    merged = list(own)
    for value in other:
