...
Several passes import from :mod:`fhy_core.symbolic.expression.registry`, which in
...
``from fhy_core.symbolic.expression.passes.evaluate import evaluate_expression``)
or from the top-level :mod:`fhy_core.symbolic.expression` package, which exposes
the public API.
"""
